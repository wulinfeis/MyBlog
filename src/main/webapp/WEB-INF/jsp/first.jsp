...
<link href="/myBlog/static/css/Location.css" type="text/css" rel="stylesheet">
<embed src="/myBlog/static/music.mp3" loop="11" autostar="true"  width="0" height="0" />
</head>
...
<div id="willerce">
<audio src="/myBlog/static/music.mp3" id="audio1" hidden="true" autoplay="autoplay" loop="loop">
      </audio>
	<div>
		<img src="/myBlog/static/images/timgs.jpg" id="logo" title="waylee"/>
		<h1>代码君小飞</h1>
		<a>脑洞技术宅!</a><br>
		<a>欢迎进入，代码的世界</a>
	</div>	
...
<div id="shiping">
	...
	<video id="bfq"   autoplay="autoplay"  loop="loop">
		<source src="/myBlog/static/hua39.mp4" type="video/mp4" id="mp4_sp">
	</video>
</div>
<span id="jb" class="copyright">&copy; 2018-2020<a href="https://waylee.net/"> 湘ICP备18012007号</a></span>

<script src="/myBlog/static/js/Seffects.js" type="text/javascript"></script>
</body>
</html>
