...
<title>代码君博客</title>
<link href="/myBlog/static/css/styles.css" rel="stylesheet" type="text/css" />
</head>

<body>
		<embed     src="/myBlog/static/mario.mp3"  type=audio/mpeg   width="0" height="0"></embed>

<script type="text/javascript" src="/myBlog/static/js/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="/myBlog/static/js/jquery-ui-1.10.2.custom.min.js"></script>
<script type="text/javascript" src="/myBlog/static/js/detect-browser-device.js"></script>
<noscript>
...
<div id="content" class="content-noscroll">
  <div id="preloader" class="displaynone">
    <script type="text/javascript" src="/myBlog/static/js/preloader-transparent-or-displaynone.js"></script>
  ...
  <script type="text/javascript" src="/myBlog/static/js/preloader.js"></script>
  <div id="page"></div>
  <div id="container" class="displaynone">
    <script type="text/javascript" src="/myBlog/static/js/container-transparent-or-displaynone.js"></script>
    ...
    <div id="layer-horizontal-3" class="layer-horizontal">
      ...
      <div id="nba-container">
        ...
        <div id="nba-board-4" class="nba-board-red">
          <div class="nba-text-container">
            <div class="nba-text">跑</div>
          </div>
        </div>
      <!--   <div id="nba-board-5" class="nba-board-red">
          <div class="nba-text-container">
            <div class="nba-text">步</div>
          </div>
        </div> -->
      ...
      <div id="buildings-container">
        ...
        <div class="ribbon-container">
          <div class="ribbon-relative">
            <div class="ribbon-left"></div>
            <div class="ribbon-middle">在魔都上海的生活和工作</div>
            <div class="ribbon-right"></div>
          </div>
        </div>
      </div>
      ...
      <div id="splash-container">
        ...
        <div class="ribbon-container">
          <div class="ribbon-relative">
            <div class="ribbon-left"></div>
            <div class="ribbon-middle">代码君小飞的平凡之路</div>
            <div class="ribbon-right"></div>
          </div>
        </div>
      </div>
        ...
        <div id="skill-2-container">
          ...
          <div id="crab-text-container">
            <div id="crab-ribbon-container-1" class="sea-ribbon-container">
              <div class="sea-ribbon-left"></div>
              <div class="sea-ribbon-middle">服务器维护</div>
              <div class="sea-ribbon-right"></div>
            </div>
            ...
            <div id="crab-ribbon-container-4" class="sea-ribbon-container">
              <div class="sea-ribbon-left"></div>
              <div class="sea-ribbon-middle">视频处理</div>
              <div class="sea-ribbon-right"></div>
            </div>
          </div>
        ...
        <div id="skill-3-container">
          ...
          <div id="turtle-text-container">
            ...
            <div id="turtle-ribbon-container-4" class="sea-ribbon-container">
              <div class="sea-ribbon-left"></div>
              <div class="sea-ribbon-middle">唱歌(跑调)</div>
              <div class="sea-ribbon-right"></div>
            </div>
          </div>
      ...
      <div id="experience-1-container">
        ...
        <div id="experience-text-container-1" class="experience-text-container">
          <div class="experience-text-a">2015年7月 - 2016年6月</div>
          <div class="experience-text-b">长沙的公司</div>
          <div class="experience-text-d">在相关科技公司实习，努力学习相关知识。</div>
        </div>
        <div id="robot">
          ...
          <div id="piechart-aol" class="piechart">
            ...
            <div id="piechart-aol-text-graphic-1" class="piechart-text-c">开发</div>
      ...
      <div id="experience-2-container">
        ...
        <div id="experience-text-container-2" class="experience-text-container">
          <div class="experience-text-a">2017年6月 - 2018年06月</div>
          <div class="experience-text-b"></div>
          <div class="experience-text-c">相关互联网项目开发</div>
        </div>
        <div id="squid">
          ...
          <div id="piechart-incognito" class="piechart">
            ...
            <div id="piechart-incognito-text-graphic-1" class="piechart-text-a">交流</div>
            <div id="piechart-incognito-text-graphic-2" class="piechart-text-b">19%</div>
            <div id="piechart-incognito-text-animation-1" class="piechart-text-c">技术</div>
            <div id="piechart-incognito-text-animation-2" class="piechart-text-d">70%</div>
            <div id="piechart-incognito-text-code-1" class="piechart-text-a">学习</div>
        ...
        <div class="ribbon-container">
          <div class="ribbon-relative">
            <div class="ribbon-left"></div>
            <div class="ribbon-middle">工作经验和能力的高速增长期</div>
            <div class="ribbon-right"></div>
          </div>
        </div>
      </div>
      ...
      <div id="experience-3-container">
        ...
        <div id="experience-text-container-3" class="experience-text-container">
          <div class="experience-text-a">2018年06月 - now</div>
          <div class="experience-text-b">互联网金融项目</div>
          <div class="experience-text-e">负责相关金融app的开发</div>
        </div>
        <div id="alien">
          ...
          <div id="piechart-foxnews" class="piechart">
            ...
            <div id="piechart-foxnews-text-graphic-1" class="piechart-text-c">后台</div>
            <div id="piechart-foxnews-text-graphic-2" class="piechart-text-d">70%</div>
            <div id="piechart-foxnews-text-animation-1" class="piechart-text-a">前端</div>
            <div id="piechart-foxnews-text-animation-2" class="piechart-text-b">15%</div>
            <div id="piechart-foxnews-text-code-1" class="piechart-text-a">linux</div>
        ...
        <div class="ribbon-container">
          <div class="ribbon-relative">
            <div class="ribbon-left"></div>
            <div class="ribbon-middle">最近的工作，方法论的沉淀</div>
            <div class="ribbon-right"></div>
          </div>
        </div>
      </div>
      ...
      <div id="banners-container">
        <div class="banner">
          ...
          <div class="banner-middle-b">
            ...
            <div class="banner-line"></div>
            <div class="banner-text-c">地址:www.wulinfei.cn</div>
            <div class="banner-button"> <a href="http://www.wulinfei.cn/" target="_blank"> <img src="/myBlog/static/image/banner-button.png"/> </a> </div>
          </div>
        ...
        <div class="banner">
          <div class="banner-top-b"></div>
          <div class="banner-middle-b">
            <div class="banner-text-a">2018</div>
            <div class="banner-line"></div>
            <div class="banner-text-b">展望未来，努力让自己变得更加优秀</div>
            <div class="banner-line"></div>
            <div class="banner-text-c">始终记得一句话：这辈子，安静的努力着~</div>
          </div>
          <div class="banner-bottom-b"></div>
        </div>
        <div class="banner">
          ...
          <div class="banner-middle-a">
            <div class="banner-text-a">2016年8</div>
            <div class="banner-line"></div>
            <div class="banner-text-b">突然又喜欢旅行</div>
            <div class="banner-line"></div>
            <div class="banner-text-c">每次周末双休都一个人出去旅行</div>
           <!--  <div class="banner-button"> <a href="http://waylee.net" target="_blank"> <img src="/myBlog/static/image/banner-button.png"/> </a> </div> -->
          </div>
        ...
        <div class="banner">
          <div class="banner-top-a"></div>
          <div class="banner-middle-a">
            <div class="banner-text-a">2016年7月</div>
            <div class="banner-line"></div>
            <div class="banner-text-b">英语</div>
            <div class="banner-line"></div>
            <div class="banner-text-c">讲英语作为兴趣，每天不断坚持练习口语和记单词</div>
            <!-- <div class="banner-button"> <a href="http://waylee.net" target="_blank"> <img src="/myBlog/static/image/banner-button.png"/> </a> </div> -->
          </div>
          <div class="banner-bottom-a"></div>
        </div>
        <div class="banner">
          <div class="banner-top-b"></div>
          <div class="banner-middle-b">
            <div class="banner-text-a">2018年6月</div>
            <div class="banner-line"></div>
            <div class="banner-text-b">开始创建个人博客网站</div>
            <div class="banner-line"></div>
            <div class="banner-text-c">不断修复各种bug，完善网站</div>
            <!-- <div class="banner-button"> <a href="http://waylee.net" target="_blank"> <img src="/myBlog/static/image/banner-button.png"/> </a> </div> -->
          </div>
          <div class="banner-bottom-b"></div>
        </div>
        <div class="banner">
          <div class="banner-top-a"></div>
          <div class="banner-middle-a">
            <div class="banner-text-a">2018年5月</div>
            <div class="banner-line"></div>
            <div class="banner-text-b">创建了自己的公众号</div>
            <div class="banner-line"></div>
            <div class="banner-text-c">努力更新相应技术文章</div>
            <div class="banner-button"> <a href="https://mp.weixin.qq.com/s/JXkbzshi5Lm_sNUOmXcNjQ" target="_blank"> <img src="/myBlog/static/image/banner-button.png"/> </a> </div>
          </div>
          <div class="banner-bottom-a"></div>
        </div>
        ...
        <div class="banner">
          ...
          <div class="banner-middle-a">
            <div class="banner-text-a">2018</div>
            <div class="banner-line"></div>
            <div class="banner-text-b">个人学习时期</div>
            <div class="banner-line"></div>
            <div class="banner-text-c">相关技术的学习，相关工作经验的不断积累</div>
            </div>
          <div class="banner-bottom-a"></div>
        </div>
        <div class="banner">
          <div class="banner-top-b"></div>
          <div class="banner-middle-b">
            <div class="banner-text-a">2017年11月</div>
            <div class="banner-line"></div>
            <div class="banner-text-b">初到上海魔都</div>
            <div class="banner-line"></div>
            <div class="banner-text-c">感受魔都生活的不易，体验到一线城市的艰辛</div>
          </div>
          <div class="banner-bottom-b"></div>
        </div>
        <div class="banner">
          <div class="banner-top-b"></div>
          <div class="banner-middle-b">
            <div class="banner-text-a">2016年</div>
            <div class="banner-line"></div>
            <div class="banner-text-b">做了人生中一次重大的决定</div>
            <div class="banner-line"></div>
            <div class="banner-text-c">决定了我的命运，改变了我的人生轨迹</div>
            </div>
          <div class="banner-bottom-b"></div>
        </div>
        <div class="banner">
          <div class="banner-top-a"></div>
          <div class="banner-middle-a">
            <div class="banner-text-a">2010年5月11日</div>
            <div class="banner-line"></div>
            <div class="banner-text-b">接触网络</div>
            <div class="banner-line"></div>
            <div class="banner-text-c">拥有了QQ,对计算机很感兴趣</div>
          </div>
          <div class="banner-bottom-a"></div>
        </div>
        <div class="banner">
          <div class="banner-top-b"></div>
          <div class="banner-middle-b">
            <div class="banner-text-a">2008年8月</div>
            <div class="banner-line"></div>
            <div class="banner-text-b">回老家</div>
            <div class="banner-line"></div>
            <div class="banner-text-c">我们家造新楼房啦</div>
          </div>
          <div class="banner-bottom-b"></div>
        </div>
        <div class="banner">
          <div class="banner-top-a"></div>
          <div class="banner-middle-a">
            <div class="banner-text-a">1995年5月21日</div>
            <div class="banner-line"></div>
      ...
      <div id="contact-center">
        ...
        <div id="contact-box">
          <div id="contact-box-email">
            <input type="text" name="email-address" id="email-address" value="hunanwulinfei@qq.com" disabled="" maxlength="75"/>
          </div>
          <div id="contact-box-subject">
            <input type="text" name="email-subject" id="email-subject" value="平凡之路" disabled="" maxlength="150"/>
          </div>
          <div id="contact-box-message">
            <textarea name="email-message" disabled="" id="email-message">座右铭:这辈子，安静的努力着。This life, quiet effort.</textarea>
          </div>
        </div>
...
<!-- <script type="text/javascript" src="/myBlog/static/js/email.js"></script> -->
<script type="text/javascript" src="/myBlog/static/js/main.js"></script>
<a style='display:none' href='../../index.html'>webhek</a> 
<script src='/myBlog/static/js/ga.js'></script><script>var shares_wb = 138;</script>
